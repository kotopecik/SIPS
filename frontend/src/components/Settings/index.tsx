...
import Calendar from "@/components/Calendar";   // ← должен быть твой полноценный календарь
    ...
    <div className={s.sidebar}>
      ...
      <div className={s.scroll}>
        ...
        <div className={s.filterBlock}>
          <div className={s.filterHeader} onClick={() => setLayerOpen(!layerOpen)}>
        ...
        <div className={s.filterBlock}>
          <div className={s.filterHeader} onClick={() => setAdditionalOpen(!additionalOpen)}>
        ...
        {/* Спутниковые снимки */}
        <div className={s.filterBlock}>
          <div className={s.filterHeader} onClick={() => setSatelliteOpen(!satelliteOpen)}>
        ...
        {/* Дата — КАЛЕНДАРЬ */}
        <div className={s.filterBlock}>
          <div className={s.filterHeader} onClick={() => setDateOpen(!dateOpen)}>
            <span>Дата</span>
